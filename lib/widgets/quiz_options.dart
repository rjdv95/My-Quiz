import 'dart:io';
import 'package:flutter_app_quiz/models/Category.dart';
import 'package:flutter_app_quiz/models/question.dart';
import 'package:flutter_app_quiz/pages/error.dart';
import 'package:flutter/material.dart';
import 'package:flutter_app_quiz/pages/quiz_page.dart';
import 'package:flutter_app_quiz/resources/api_provider.dart';
      ...
      child: Column(
        children: <Widget>[
          Container(
            ...
            child: Text(widget.category.name, textAlign: TextAlign.center,  style: Theme.of(context).textTheme.headline5.copyWith(),),
          ),
          ...
          SizedBox(height: 20.0),
          processing ? CircularProgressIndicator() : ButtonTheme(
            minWidth: 300,
            height: 50,
